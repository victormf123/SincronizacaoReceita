package br.com.matheusfreitas.sincronizacaoreceita;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;


import br.com.matheusfreitas.sincronizacaoreceita.processor.Processor;
...
public class SincronizacaoReceita {
	public static void main(String[] args) {
		...
		new Processor().gerarRelatorioProcessamentoContas(args[0]);
